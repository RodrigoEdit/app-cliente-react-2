    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input className="form-control" type="text" id="categoria" name="categoria" onChange={(e)=>setCategoria(e.target.value)} />
                <label>Descripción</label>
                <input  className="form-control" type="text" id="descripcion" name="descripcion" onChange={(e)=>setDescripcion(e.target.value)} />
